...
export class GenreByWebtoonComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.webtoonStore$.dispatch(WebtoonActions.SetNActiveGenre({ genre: 'romance' }));
        this.webtoonStore$.dispatch(WebtoonActions.FetchNGenresBannerList({ params: {}, category: 'genre' }));
    ...
    changeTab(tabInfo: any) {
        ...
        this.webtoonStore$.dispatch(WebtoonActions.SetNActiveGenre({ genre }));
    }
    ...
    private fetchActiveBanner(genre: string, banners: any[]) {
        ...
        this.webtoonStore$.dispatch(WebtoonActions.FetchNActiveGenreBanner({ bannerId: currentActiveGenreBannerId }));
    }
    ...
    private getTitles(params: any = {}) {
        this.webtoonStore$.dispatch(WebtoonActions.FetchNovelList({ params }));
    }
